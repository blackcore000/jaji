...
export default function CreatePost() {
  ...
  const submit = async (e) => {
    ...
    setContent(""); setImage("");
    alert("Paylaşıldı! Ana sayfadan görebilirsin.");
  };
  ...
  return (
    <div className="card">
      ...
      <form onSubmit={submit} style={{display:"grid", gap:10}}>
        ...
        <textarea className="textarea" rows={4} value={content} onChange={e=>setContent(e.target.value)} placeholder="Ne düşünüyorsun?" />
